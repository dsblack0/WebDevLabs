...
function greetingFunc() {
    ...
    if (h>=5 && h<12) {
        E.innerHTML = "Good morning, I am Samhitha.";
    } else if (h>=12 && h<18) {
        E.innerHTML = "Good afternoon, I am Samhitha.";
    } else if (h>=18 && h<20) {
        E.innerHTML = "Good evening, I am Samhitha.";
    } else if (h>=20 && h<24 || h<5) {
        E.innerHTML = "Good night, I am Samhitha";
    }
}
...
async function initMap() {
    const position = { lat: 32.850568, lng:-117.272955 };   
